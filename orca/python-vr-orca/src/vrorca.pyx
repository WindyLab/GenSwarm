...
cdef extern from "RVOSimulator.h" namespace "RVO":
    cdef cppclass RVOSimulator:
        ...
        RVOSimulator(float timeStep, float neighborDist, size_t maxNeighbors,
                     ...
                     float maxSpeed, float prefSpeed, const Vector2 & velocity)
        ...
        void setAgentDefaults(float neighborDist, size_t maxNeighbors,
                              ...
                              float radius, float maxSpeed, float prefSpeed,
                              const Vector2 & velocity)
...
cdef class PyVRORCASimulator:
    ...
    def __cinit__(self, float timeStep, float neighborDist, size_t maxNeighbors,
        ...
        Args:
            timeStep: Time step of the simulation (must be positive)
            neighborDist: Maximum distance to other agents to consider (non-negative)
            maxNeighbors: Maximum number of neighbors to consider
            timeHorizon: Time horizon for collision avoidance with other agents (positive)
            timeHorizonObst: Time horizon for collision avoidance with obstacles (positive)
            radius: Default radius of agents (non-negative)
            maxSpeed: Default maximum speed of agents (non-negative)
            prefSpeed: Default preferred speed of agents (non-negative)

...
# ======== 数据与标签设置 ========
prompt_rename = {
    'default': 'Plain-Compound(Cohesive)',
    'compound': 'Plain-Compound',
    'simple': 'Plain-Objective',
    'simple_strategy': 'Plain-Policy',
    'narrative': 'Plain-Narrative',
    'structured_default': 'Structured-Objective',
    'structured_strategy': 'Structured-Policy'
}
...
data = {
    'gpt-4o': {
        'default': [0.659091, 0.72, 0.74],
        'compound': [0.58, 0.66, 0.72],
        ...
        'structured_strategy': [0.58, 0.6, 0.67]
    },
    'o1-mini': {
        'default': [0.86, 0.82, 0.66],
        'compound': [0.72, 0.74, 0.76],
    ...
    'DeepSeek-V3': {
        'default': [0.782609, 0.86, 0.92],
        'compound': [0.8, 0.9, 0.92],
        'narrative': [0.690476, 0.714286, 0.866667],
        'simple': [0.520833, 0.511628, 0.914894],
        'simple_strategy': [0.91, 0.738095, 0.880952],
...
gs = fig.add_gridspec(1, 4, width_ratios=[1, 1, 1, 0.03], wspace=0.01)
...
for idx, model in enumerate(models):
    ...
    hm.set_xticklabels(hm.get_xticklabels(), rotation=25)
...
# 保存图表到results/charts目录
output_dir = "../../results/charts"
os.makedirs(output_dir, exist_ok=True)
output_path = os.path.join(output_dir, "prompt_type_heatmaps.svg")

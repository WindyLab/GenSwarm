...
METHOD_COLORS = {
    "ours": color_rgb_to_hex((140, 205, 191)),
    "ours w/o vlm": color_rgb_to_hex((205, 224, 165)),
    "cap": color_rgb_to_hex((239, 132, 118)),
    "metagpt": color_rgb_to_hex((197, 168, 206)),
...
def main():
    ...
    # 从 JSON 文件加载数据
    file_path = "combined_success_rates.json"  # 文件路径
    ...
    methods = ["ours", "ours w/o vlm", "cap", "metagpt", "llm2swarm"]

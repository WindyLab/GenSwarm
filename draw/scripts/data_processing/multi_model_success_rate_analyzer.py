...
if __name__ == "__main__":
    ...
    # 输出文件路径配置 - 统一保存到results/data目录
    results_dir = "../../results/data"
    os.makedirs(results_dir, exist_ok=True)
    
    output_file_4o = os.path.join(results_dir, "4o_success_rates.json")
    output_wo_vlm_file = os.path.join(results_dir, "wo_vlm_4o_success_rates.json")
    output_file_o1_mini = os.path.join(results_dir, "o1_mini_success_rates.json")
    output_combined_file = os.path.join(results_dir, "model_combined_success_rates.json")
